...
/**
 * @brief Determines if a given sequence is a valid sequence of axes from which a rotation matrix
 * and unit quaternion can be calculated.
 *
 * @param[in] sequence A string that potentially represents a rotation sequence
 *
 * @return True if the input sequence is a valid rotation sequence, false otherwise.
 */
